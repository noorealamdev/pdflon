...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
          href="{{ asset('/tool-frontend/app-assets/images/ico/favicon.ico') }}">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/app-assets/fonts/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/tool-frontend/app-assets/css/themes/dark-layout.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/app-assets/css/themes/bordered-layout.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/app-assets/css/themes/semi-dark-layout.css') }}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/app-assets/css/core/menu/menu-types/horizontal-menu.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/assets/plugins/color-picker/light.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/tool-frontend/assets/plugins/font-picker/jquery.fontselect.min.css') }}">
...
<body class="designTron horizontal-layout horizontal-menu navbar-floating footer-static  " data-open="hover"
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            @if(Auth::user())
                ...
                <li class="dropdown dropdown-notification">
                    <div class="btn btn-outline-success mr-1 waves-effect waves-float waves-light"
                         data-toggle="dropdown">
                        <strong>Save</strong>
                        <i data-feather="save" class="download-btn-icon"></i>
                    </div>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right" style="margin-right: 15px;">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header">
                                <input type="text" class="form-control" id="saveFileName" placeholder="File Name">
                                <button id="saveBtn" type="button" style="width: 100%"
                                        class="mt-1 justify-content-center btn btn-primary waves-effect waves-float waves-light">
                                    Save
                                </button>
                            </div>
                        </li>
            ...
            @else
                <li class="dropdown dropdown-notification">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right" style="margin-right: 15px;">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header">
                                <p>You need to login to save files</p>
                                <a target="_blank" href="{{ url('/register') }}" style="width: 100%"
                                   class="mt-1 justify-content-center btn btn-primary waves-effect waves-float waves-light">Login</a>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <li class="dropdown dropdown-notification">
                <div class="btn btn-primary waves-effect waves-float waves-light" data-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    <li class="dropdown-menu-header">
                        <div class="dropdown-header">
                            ...
                            <button id="downloadBtn" type="button" style="width: 100%"
                                    class="mt-1 justify-content-center btn btn-primary waves-effect waves-float waves-light">
                                Download
                            </button>
                        </div>
...
<script src="{{ asset('/tool-frontend/assets/plugins/masonry/masonry.pkgd.min.js') }}"></script>
